 ...
 */
public interface FileDownloadProcessor<T extends InputStream>
{
  void processDownload(HttpServletResponse response, String fileName, Source<T> source) throws RuntimeIoException;
}
